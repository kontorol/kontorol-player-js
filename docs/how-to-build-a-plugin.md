...
```js
var MyPlugin = function(name, player, config) {
  KontorolPlayer.core.BasePlugin.call(this, name, player, config);
};

MyPlugin.createPlugin = KontorolPlayer.core.BasePlugin.createPlugin;

MyPlugin.prototype = new KontorolPlayer.core.BasePlugin();
```

### _ES6_

```typescript
class MyPlugin extends KontorolPlayer.core.BasePlugin {
  constructor(name, player, config) {
...
<body>
<script>
	KontorolPlayer.core.registerPlugin("myPlugin", MyPlugin);
</script>
</body>
</html>
```
...
<br>Read [here](https://github.com/kontorol/pakhshkit-js-plugin-generator) to learn more.
