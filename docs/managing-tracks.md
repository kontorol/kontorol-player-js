...
The Kontorol Player uses a comprehensive API to handle all kind of tracks, including video (bitrate), audio, and text (language) tracks.
...
> You can set a custom label to a Text Track - read about it [here](https://github.com/kontorol/pakhshkit-js/blob/master/docs/configuration.md#configcustomlabels)
