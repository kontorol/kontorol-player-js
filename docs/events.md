...
The full core events list can be found [here](https://github.com/kontorol/pakhshkit-js/blob/master/src/event/event-type.js).
...
The full UI events list can be found [here](https://github.com/kontorol/pakhshkit-js-ui/blob/master/docs/events.md).
