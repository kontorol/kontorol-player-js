...
##### Prerequisites
- [ ] Have you checked for duplicate [issues](https://github.com/kontorol/kontorol-player-js/issues): ______
- [ ] Which Plugin [version](https://github.com/kontorol/kontorol-player-js/releases) are you using: ______
